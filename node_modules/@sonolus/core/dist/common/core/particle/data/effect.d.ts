...
export type ParticleDataTransform = Record<`${'x' | 'y'}${1 | 2 | 3 | 4}`, Partial<Record<'c' | `${'x' | 'y'}${1 | 2 | 3 | 4}` | `${'r' | 'sinr' | 'cosr'}${1 | 2 | 3 | 4 | 5 | 6 | 7 | 8}`, number>>>;
...
export type ParticleDataGroupParticlePropertyExpression = Partial<Record<'c' | `${'r' | 'sinr' | 'cosr'}${1 | 2 | 3 | 4 | 5 | 6 | 7 | 8}`, number>>;
