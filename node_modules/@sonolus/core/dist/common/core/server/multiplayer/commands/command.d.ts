...
export type Command = AddChatMessageCommand | AddSuggestionCommand | ClearSuggestionsCommand | FinishGameplayCommand | RemoveSuggestionCommand | RemoveUserCommand | ReportUserCommand | ResetScoreboardCommand | StartGameplayCommand | SwapSuggestionsCommand | UpdateAutoExitCommand | UpdateIsSuggestionsLockedCommand | UpdateLeadCommand | UpdateLevelCommand | UpdateLevelOptionCommand | UpdateMasterCommand | UpdateOptionValuesCommand | UpdateStatusCommand | UpdateUserStatusCommand;
