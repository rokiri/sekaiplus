...
export type Event = AddChatMessageEvent | AddResultEvent | AddSuggestionEvent | AddUserEvent | ArrangeScoreboardSectionScoresEvent | ClearSuggestionsEvent | InsertScoreboardSectionEvent | InsertScoreboardSectionScoreEvent | MergeScoreboardSectionScoresEvent | MoveScoreboardSectionEvent | MoveScoreboardSectionScoreEvent | RemoveScoreboardSectionEvent | RemoveScoreboardSectionScoreEvent | RemoveSuggestionEvent | RemoveUserEvent | StartRoundEvent | SwapScoreboardSectionScoresEvent | SwapScoreboardSectionsEvent | SwapSuggestionsEvent | UpdateAutoExitEvent | UpdateEvent | UpdateIsSuggestionsLockedEvent | UpdateLeadEvent | UpdateLevelEvent | UpdateLevelOptionEvent | UpdateLevelOptionsEvent | UpdateMasterEvent | UpdateOptionsEvent | UpdateOptionValuesEvent | UpdateScoreboardDescriptionEvent | UpdateScoreboardSectionEvent | UpdateScoreboardSectionIconEvent | UpdateScoreboardSectionScoresEvent | UpdateScoreboardSectionScoresValueEvent | UpdateScoreboardSectionsEvent | UpdateScoreboardSectionTitleEvent | UpdateStatusEvent | UpdateSuggestionsEvent | UpdateTitleEvent | UpdateUsersEvent | UpdateUserStatusesEvent | UpdateUserStatusEvent;
